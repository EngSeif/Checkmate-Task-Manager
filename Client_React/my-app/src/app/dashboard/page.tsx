        ...
        <>
            <div className='flex w-[92%] justify-between mx-auto my-4 items-center'>
                <div className='flex gap-2'>
                    ...
                    <button><FontAwesomeIcon icon={faMagnifyingGlass} className='dark:text-white' /></button>
                </div>
                <div className='flex w-[25%] gap-3 items-center justify-end'>
                        <FontAwesomeIcon className='text-[#6c64ee] text-2xl cursor-pointer lg:hidden' icon={faBars} onClick={()=>{
                            toggleNav();
                        }}/>
